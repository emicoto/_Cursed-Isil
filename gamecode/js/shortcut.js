...
F.baseCheck = function(chara, key, val){
	...
	else return chara.base[key][0] < chara.base[key][1] * (val/100)
}
...
F.palamCheck = function(chara, key, val){
	...
	else chara.palam[key][1] < chara.palam[key][2] * (val/100)
}
...
F.isEnergetic = function(a){
	...
	if(Config.debug)
		console.log(hp, stamina, sanity, mana);
	//2, 200, 150, 50
