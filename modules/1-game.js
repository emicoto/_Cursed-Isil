(function () {
	...
	class Chara {
		...
		setPenis(adj) {
			...
			if (P2.trait.includes("\u6D53\u539A")) P2.maxcum *= 10;
			return this;
		}
		setCrit() {
		...
		setUrin() {
			...
			this.sexstats.u.l = ((_b = (_a = this.sexstats) == null ? void 0 : _a.p) == null ? void 0 : _b.l)
				? this.sexstats.p.l + random(24, 40)
				: 42 + random(1, 20) + bodysize * 6;
			if (this.gender === "female") {
