...
window.EventDialog = function(chapter){
    ...
    const reset = c?.reset ? c.reset :`<<set $event.phase = 0>><<set $event.lastId = $selectId>><<set $selectId = 0>><<set S.dialog = {}>><<set $event.sp = 0>>`
